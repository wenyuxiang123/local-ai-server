...
//  ZhaodeWang
//
//  MNN 3.5.0 LLM API Header
//  Supports new flatbuffers format (magic 0x20/0x24)
//
#ifndef LLM_hpp
#define LLM_hpp
...
#include <cstreambuf>
#include <cfunctional>
#include <cunordered_map>
#include <cMNN/expr/Expr.hpp>
#include <cMNN/expr/Module.hpp>
#include <cMNN/expr/MathOp.hpp>
#include <cMNN/expr/NeuralNetWorkOp.hpp>
#include <cMNN/expr/ExecutorScope.hpp>
...
public:
    ...
    // Factory method - creates LLM instance from config path
    ...
    // response APIs - MNN 3.5.0 compatible
    ...
    // generate APIs - MNN 3.5.0 compatible
    ...
    // Note: MNN 3.5.0 uses stoped() not stopped()
    bool stoped();
